...
function renderStatusHtml(html, stats) {
  ...
  const summaryTitle = allOnline ? "Operational" : "Service disruption detected";
  const summaryCopy = allOnline
    ? "All systems operational. Beacon Bot and its Discord services are responding normally."
...
<html lang="en">
  <head>
    ...
    <meta name="theme-color" content="#292b36" />
  ...
  <body>
    <main>
      <section class="status-summary" aria-live="polite">
        <div class="summary-icon" data-summary-icon aria-hidden="true">&#10003;</div>
        <div>
          <p class="eyebrow">Beacon Bot</p>
          <h1>System Status</h1>
          <p data-summary-copy>All systems operational. Beacon Bot and its Discord services are responding normally.</p>
          <span class="status-pill" data-summary-title>Operational</span>
        </div>
      </section>
      ...
      <section class="services" aria-labelledby="services-title">
        <div class="section-heading">
          <div>
            <p class="eyebrow">Uptime over the past 30 days</p>
            <h2 id="services-title">Service history</h2>
          </div>
          <p>Hover over a bar for details</p>
        </div>
        ...
        <article class="service" data-service="website">
          <div class="service-heading">
            <div><span class="service-check">&#10003;</span><h3>Beacon Website</h3></div>
            <strong data-service-uptime>Checking...</strong>
          </div>
