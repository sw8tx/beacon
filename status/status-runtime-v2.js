...
async function refreshStatus() {
  ...
  try {
    ...
    summaryTitle.textContent = allOnline ? "Operational" : "Service disruption detected";
    summaryCopy.textContent = allOnline ? "All systems operational. Beacon Bot and its Discord services are responding normally." : "At least one Beacon service is not responding normally.";
