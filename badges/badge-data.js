export const BEACON_BADGES = [
  ...
  {
    id: "bug-hunter",
    assetId: "bug-hunter-blue",
    name: "Bug Hunter",
    tag: "Report",
    tone: "blue",
    icon: "BH",
    summary: "Reported a real Beacon bug that got confirmed.",
    hint: "A confirmed report with clear steps, screenshots or logs unlocks this badge.",
  },
  {
    id: "golden-bug-hunter",
    assetId: "golden-bug-hunter",
    name: "Golden Bug Hunter",
    tag: "Special",
    tone: "gold",
    icon: "GB",
    summary: "Found multiple confirmed Beacon bugs and kept helping us fix them.",
    hint: "Awarded after several genuine, confirmed bug reports — quality matters more than volume.",
  },
  {
    id: "server-booster",
    name: "Server Booster",
