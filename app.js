...
const pageTranslations = {
  en: { serverStrip: "Professional servers running Beacon", giveawaysOverline: "Giveaways", giveawaysTitle: "Reward your community", giveawaysCopy: "Entry requirements, bonus entries, automatic winner DMs and clean anti-spam controls.", messagesOverline: "Message counting", messagesTitle: "Measure real activity", messagesCopy: "Per-member counts, live role rewards and readable growth over the last seven days.", leaderboardOverline: "Leaderboards", leaderboardTitle: "Put champions on display", leaderboardCopy: "Auto-updating boards, pinned where members see them with hourly syncs.", nitroDrop: "Nitro drop", endsIn: "Ends in", running: "Running", entries: "Entries", winners: "Winners", enterGiveaway: "Enter giveaway", messages7Days: "Messages · 7 days", roleNote: "@Regular granted at 10k messages", leaderboardLabel: "# Leaderboard", updatesHourly: "Updates hourly", upgradeTitle: "Ready to upgrade your server?", upgradeCopy: "Join growing communities already using Beacon to manage tickets, rewards, roles, commands and real-time server insights.", upgradeAdd: "Add to Discord", upgradeStatus: "Check Status", builtBy: "Built by Sparkle", sponsoredBy: "Sponsored by", legalTerms: "Terms of Use", legalPrivacy: "Privacy Policy", legalCopyright: "Copyright Dispute", legalGdpr: "GDPR Notice", legalCookies: "Cookie Policy", legalEula: "EULA", footerRights: "© 2026 Beacon. All rights reserved. Beacon is not affiliated with Discord Inc." },
  fr: { serverStrip: "Serveurs professionnels utilisant Beacon", giveawaysOverline: "Giveaways", giveawaysTitle: "Récompensez votre communauté", giveawaysCopy: "Conditions d'entrée, participations bonus, messages automatiques aux gagnants et protection anti-spam.", messagesOverline: "Compteur de messages", messagesTitle: "Mesurez l'activité réelle", messagesCopy: "Compteurs par membre, récompenses de rôles en direct et croissance lisible sur les sept derniers jours.", leaderboardOverline: "Classements", leaderboardTitle: "Mettez les champions en avant", leaderboardCopy: "Classements mis à jour automatiquement et visibles par tous, avec synchronisation horaire.", nitroDrop: "Drop Nitro", endsIn: "Se termine dans", running: "En cours", entries: "Participations", winners: "Gagnants", enterGiveaway: "Participer au giveaway", messages7Days: "Messages · 7 jours", roleNote: "@Regular attribué à 10 000 messages", leaderboardLabel: "# Classement", updatesHourly: "Mise à jour chaque heure", upgradeTitle: "Prêt à améliorer votre serveur ?", upgradeCopy: "Rejoignez les communautés qui utilisent Beacon pour gérer tickets, récompenses, rôles, commandes et statistiques en temps réel.", upgradeAdd: "Ajouter à Discord", upgradeStatus: "Voir le statut", builtBy: "Créé par Sparkle", sponsoredBy: "Sponsorisé par", legalTerms: "Conditions d'utilisation", legalPrivacy: "Politique de confidentialité", legalCopyright: "Litige de copyright", legalGdpr: "Avis RGPD", legalCookies: "Politique des cookies", legalEula: "CLUF", footerRights: "© 2026 Beacon. Tous droits réservés. Beacon n'est pas affilié à Discord Inc." },
...
const showcaseTranslations = {
  ...
  fr: { purgeOverline: "MODÉRATION", purgeTitle: "Nettoyez votre serveur rapidement", purgeCopy: "Gardez les conversations claires avec des commandes de modération simples. /purge supprime jusqu'à 99 messages récents et /purge-user efface les messages récents d'un utilisateur choisi.", purgeAction: "Découvrir la modération", customizeOverline: "PERSONNALISATION", customizeTitle: "Personnalisez votre bot", customizeCopy: "Donnez à votre bot une identité adaptée à votre communauté. Modifiez son avatar, sa bannière et sa bio depuis un tableau de bord unique.", customizeAction: "Personnaliser le bot", mockCommandTitle: "Nouvelle commande personnalisée", customOverline: "AUTOMATISATION", customTitle: "Commandes personnalisées avancées", customCopy: "Donnez plus de puissance à votre serveur avec des commandes qui automatisent les tâches, simplifient les rôles et envoient des messages personnalisés.", socialOverline: "ACTIVITÉ DE LA COMMUNAUTÉ", socialTitle: "Restez connecté à votre communauté", socialCopy: "Envoyez des notifications en temps réel pour les streams, vidéos, événements et activités du serveur.", featureAction: "Ajouter à Discord" },
  de: { purgeOverline: "MODERATION", purgeTitle: "Räume deinen Server schnell auf", purgeCopy: "Halte Gespräche übersichtlich mit einfachen Moderations-Commands. /purge löscht bis zu 99 aktuelle Nachrichten, während /purge-user aktuelle Nachrichten eines ausgewählten Users entfernt.", purgeAction: "Moderation entdecken", customizeOverline: "ANPASSUNG", customizeTitle: "Passe deinen Bot an", customizeCopy: "Gib deinem Bot eine Persönlichkeit, die zu deiner Community passt. Ändere Avatar, Banner und Bio übersichtlich in einem Dashboard und speichere deine Änderungen.", customizeAction: "Bot anpassen", mockCommandTitle: "Neuer benutzerdefinierter Command", customOverline: "AUTOMATISIERUNG", customTitle: "Erweiterte benutzerdefinierte Commands", customCopy: "Stärke deinen Server mit Commands, die Aufgaben automatisieren, Rollen verwalten und personalisierte Nachrichten senden.", socialOverline: "COMMUNITY-AKTIVITÄT", socialTitle: "Bleib mit deiner Community verbunden", socialCopy: "Sende Echtzeit-Benachrichtigungen für Streams, Videos, Events und Server-Aktivitäten.", featureAction: "Zu Discord hinzufügen" },
};
...
Object.assign(translations.ar, {
  label: "العربية", code: "SA", bot: "بوت بيكون", support: "خادم الدعم", join: "انضم إلى ديسكورد", help: "المساعدة", commands: "الأوامر", status: "الحالة", ping: "زمن الاستجابة", prestige: "Beacon Prestige", new: "جديد!", add: "إضافة إلى الخادم", login: "تسجيل الدخول عبر ديسكورد", eyebrow: "بوت ديسكورد المتكامل لخادمك", heroLineOne: "كبّر خادمك.", heroLineTwo: "قوِّ مجتمعك.", heroDescription: "Beacon هو بوت ديسكورد متكامل يساعدك على تنمية خادمك وإدارته والتفاعل مع مجتمعك بأدوات قوية ولوحة تحكم سهلة.", checkOne: "نظام التذاكر", checkTwo: "الرد التلقائي", checkThree: "الملاحظات المثبتة", checkFour: "إحصائيات الخادم", checkFive: "أمر /Say", checkSix: "والمزيد...", heroAdd: "إضافة إلى ديسكورد", heroLogin: "تسجيل الدخول عبر ديسكورد", docs: "عرض التوثيق", heroNote: "موثوق من المجتمعات النامية", livePreview: "معاينة لوحة التحكم المباشرة", builtFor: "مصمم لمستواك القادم", liveStatus: "حالة النظام المباشرة", statServers: "الخوادم المتصلة", statUsers: "الأعضاء الذين تم الوصول إليهم", statPing: "متوسط الاستجابة", statUptime: "متاح دائمًا", featureOverline: "كل شيء في مكان واحد", featureTitle: "مجتمعك،\nفي أفضل حالاته.", featureDescription: "أتمتة قوية وإشراف سهل ورؤية واضحة لاتخاذ قرارات أفضل لخادمك.", featureOneTitle: "أتمت المهام المتكررة", featureOneCopy: "دع Beacon يتولى المهام المتكررة وركز على مجتمعك.", featureTwoTitle: "شاهد ما يهم", featureTwoCopy: "إحصائيات مباشرة ورؤى واضحة عندما تحتاج إليها.", featureThreeTitle: "اجعله مناسبًا لك", featureThreeCopy: "أوامر وأدوات مرنة تناسب طريقة عمل خادمك.", learnMore: "استكشف الميزة", finalOverline: "جاهز عندما تكون جاهزًا", finalTitle: "امنح خادمك\nلمسة Beacon.", footer: "مصمم للمجتمعات الطموحة.", navBadges: "الشارات", navCommands: "الأوامر", navDashboard: "لوحة التحكم", navPrestige: "Prestige", navDocs: "التوثيق", navSupport: "الدعم", navStatus: "الحالة", footerProduct: "المنتج", footerDocumentation: "التوثيق", footerPrivacy: "الخصوصية", footerTerms: "الشروط", footerImprint: "بيانات النشر",
  serverStrip: "خوادم احترافية تستخدم Beacon", giveawaysOverline: "الهدايا", giveawaysTitle: "كافئ مجتمعك", giveawaysCopy: "شروط دخول ومشاركات إضافية ورسائل تلقائية للفائزين وحماية فعالة من الإزعاج.", messagesOverline: "عدّ الرسائل", messagesTitle: "قِس النشاط الحقيقي", messagesCopy: "إحصائيات لكل عضو ومكافآت أدوار مباشرة ونمو واضح خلال آخر سبعة أيام.", leaderboardOverline: "لوحات الصدارة", leaderboardTitle: "اعرض أبطال مجتمعك", leaderboardCopy: "لوحات محدثة تلقائيًا ومتزامنة كل ساعة.", nitroDrop: "جائزة Nitro", endsIn: "ينتهي خلال", running: "قيد التشغيل", entries: "المشاركات", winners: "الفائزون", enterGiveaway: "شارك في الهدية", messages7Days: "الرسائل · 7 أيام", roleNote: "يُمنح دور @Regular عند 10,000 رسالة", leaderboardLabel: "# لوحة الصدارة", updatesHourly: "تحديث كل ساعة", upgradeTitle: "هل أنت مستعد لتطوير خادمك؟", upgradeCopy: "انضم إلى المجتمعات التي تستخدم Beacon لإدارة التذاكر والمكافآت والأدوار والأوامر والإحصائيات المباشرة.", upgradeAdd: "إضافة إلى ديسكورد", upgradeStatus: "عرض الحالة", builtBy: "بناء Sparkle", sponsoredBy: "برعاية", legalTerms: "شروط الاستخدام", legalPrivacy: "سياسة الخصوصية", legalCopyright: "نزاع حقوق النشر", legalGdpr: "إشعار GDPR", legalCookies: "سياسة ملفات الارتباط", legalEula: "اتفاقية المستخدم", footerRights: "© 2026 Beacon. جميع الحقوق محفوظة. Beacon غير تابع لشركة Discord Inc.", purgeOverline: "الإشراف", purgeTitle: "نظّف خادمك بسرعة", purgeCopy: "حافظ على تنظيم المحادثات باستخدام أوامر إشراف بسيطة.", purgeAction: "استكشف الإشراف", customizeOverline: "التخصيص", customizeTitle: "خصص بوتك", customizeCopy: "امنح بوتك شخصية تناسب مجتمعك وعدّل صورته ووصفه من لوحة تحكم واحدة.", customizeAction: "تخصيص البوت", mockCommandTitle: "أمر مخصص جديد", customOverline: "الأتمتة", customTitle: "أوامر مخصصة متقدمة", customCopy: "قوِّ خادمك بأوامر تؤتمت المهام وتدير الأدوار وترسل رسائل مخصصة.", socialOverline: "نشاط المجتمع", socialTitle: "ابقَ متصلًا بمجتمعك", socialCopy: "أرسل إشعارات مباشرة للبثوث والفيديوهات والأحداث ونشاط الخادم.", featureAction: "إضافة إلى ديسكورد"
});

Object.keys(translations).forEach((language) => {
  translations[language].builtBy = "Built with ❤️ by a solo developer";
});
...
function setLanguage(language) {
  ...
  startHeroTypewriter(dictionary.heroLineOne || heroTypewriter?.dataset.typewriterLines || "");
